...
public class BaseMDBImpl<T> implements BaseDao<T> {
	...
	public T findOne(String qlstr) {
		return (T) this.mongoTemplate.findOne(new BasicQuery(qlstr),
				entityClass);
	}
	...
	/**
	 * Create Query, translate a HashMap parameter to Query. eg. new
	 * Parameter().put("name", "xxx").put("age",24) --> {"name" : "xxx" , "age"
	 * : 24 }
	 * 
	 * @param parameters
	 * @param qlstr
